...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_22", {
        get: function () {
            if ((this.__EventManager_22 == null)) {
                (this.__EventManager_22 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_21, this.parent.get(import44.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_26", {
        get: function () {
            if ((this.__RootRenderer_26 == null)) {
                (this.__RootRenderer_26 = import45._createConditionalRootRenderer(this._DomRootRenderer_25, this.parent.get(import45.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_43", {
        get: function () {
            if ((this.__LocationStrategy_43 == null)) {
                (this.__LocationStrategy_43 = import7.provideLocationStrategy(this.parent.get(import46.PlatformLocation), this.parent.get(import47.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_42));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreventUnsavedChangesGuard_52", {
        get: function () {
            if ((this.__PreventUnsavedChangesGuard_52 == null)) {
                (this.__PreventUnsavedChangesGuard_52 = new import31.PreventUnsavedChangesGuard());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AuthService_53", {
        get: function () {
            if ((this.__AuthService_53 == null)) {
                (this.__AuthService_53 = new import32.AuthService(this._Http_41));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_6 = import7.provideForRootGuard(this.parent.get(import54.Router, null));
        ...
        this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import44.NgZone), this.parent.get(import55.Console), this, this._ErrorHandler_12, this, this._ApplicationInitStatus_13, this.parent.get(import11.TestabilityRegistry, null), this._Testability_14);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import31.PreventUnsavedChangesGuard)) {
            return this._PreventUnsavedChangesGuard_52;
        }
