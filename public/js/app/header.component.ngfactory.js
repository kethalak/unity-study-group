...
var _View_HeaderComponent0 = (function (_super) {
    ...
    _View_HeaderComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_34 = this.renderer.createElement(this._el_32, 'a', null);
        ...
        this._text_35 = this.renderer.createText(this._el_34, 'Resources ', null);
        ...
        this._el_38 = this.renderer.createElement(this._el_32, 'ul', null);
        this.renderer.setElementAttribute(this._el_38, 'class', 'dropdown-menu');
        this._text_39 = this.renderer.createText(this._el_38, '\n            ', null);
        this._el_40 = this.renderer.createElement(this._el_38, 'li', null);
        ...
        this._text_42 = this.renderer.createText(this._el_41, 'Collision Table', null);
        ...
        this._el_47 = this.renderer.createElement(this._el_26, 'li', null);
        ...
        this._text_50 = this.renderer.createText(this._el_49, 'Unity Official ', null);
        ...
        this._el_53 = this.renderer.createElement(this._el_47, 'ul', null);
        this.renderer.setElementAttribute(this._el_53, 'class', 'dropdown-menu');
        this._text_54 = this.renderer.createText(this._el_53, '\n            ', null);
        this._el_55 = this.renderer.createElement(this._el_53, 'li', null);
        this._el_56 = this.renderer.createElement(this._el_55, 'a', null);
        this.renderer.setElementAttribute(this._el_56, 'href', 'https://docs.unity3d.com/ScriptReference/');
        this._text_57 = this.renderer.createText(this._el_56, 'Scripting API', null);
        this._text_58 = this.renderer.createText(this._el_53, '\n            ', null);
        this._el_59 = this.renderer.createElement(this._el_53, 'li', null);
        this._el_60 = this.renderer.createElement(this._el_59, 'a', null);
        this.renderer.setElementAttribute(this._el_60, 'href', 'https://forum.unity3d.com/');
        this._text_61 = this.renderer.createText(this._el_60, 'Forums', null);
        this._text_62 = this.renderer.createText(this._el_53, '\n            ', null);
        this._el_63 = this.renderer.createElement(this._el_53, 'li', null);
        this._el_64 = this.renderer.createElement(this._el_63, 'a', null);
        this.renderer.setElementAttribute(this._el_64, 'href', 'http://wiki.unity3d.com/index.php/Main_Page');
        this._text_65 = this.renderer.createText(this._el_64, 'Wiki', null);
        this._text_66 = this.renderer.createText(this._el_53, '\n            ', null);
        this._el_67 = this.renderer.createElement(this._el_53, 'li', null);
        this._el_68 = this.renderer.createElement(this._el_67, 'a', null);
        this.renderer.setElementAttribute(this._el_68, 'href', 'https://www.youtube.com/user/Unity3D');
        this._text_69 = this.renderer.createText(this._el_68, 'YouTube', null);
        this._text_70 = this.renderer.createText(this._el_53, '\n            ', null);
        this._el_71 = this.renderer.createElement(this._el_53, 'li', null);
        this._el_72 = this.renderer.createElement(this._el_71, 'a', null);
        this.renderer.setElementAttribute(this._el_72, 'href', 'https://www.unity3d.com/learn');
        this._text_73 = this.renderer.createText(this._el_72, 'Learn', null);
        this._text_74 = this.renderer.createText(this._el_53, '\n            ', null);
        this._el_75 = this.renderer.createElement(this._el_53, 'li', null);
        this._el_76 = this.renderer.createElement(this._el_75, 'a', null);
        this.renderer.setElementAttribute(this._el_76, 'href', 'https://store.unity.com/front-page');
        this._text_77 = this.renderer.createText(this._el_76, 'Get Unity', null);
        ...
        this._el_83 = this.renderer.createElement(this._el_24, 'ul', null);
    ...
    _View_HeaderComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import13.RouterLinkWithHref) && ((41 <= requestNodeIndex) && (requestNodeIndex <= 42)))) {
            return this._RouterLinkWithHref_41_3;
        }
        if (((token === import20.TemplateRef) && (85 === requestNodeIndex))) {
            return this._TemplateRef_85_5;
        }
        if (((token === import16.NgIf) && (85 === requestNodeIndex))) {
            return this._NgIf_85_6;
        }
        if (((token === import20.TemplateRef) && (87 === requestNodeIndex))) {
            return this._TemplateRef_87_5;
        }
        if (((token === import16.NgIf) && (87 === requestNodeIndex))) {
            return this._NgIf_87_6;
        }
        if (((token === import20.TemplateRef) && (89 === requestNodeIndex))) {
            return this._TemplateRef_89_5;
        }
        if (((token === import16.NgIf) && (89 === requestNodeIndex))) {
    ...
    _View_HeaderComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_9 = this._RouterLinkWithHref_41_3.href;
    ...
    _View_HeaderComponent0.prototype._handle_click_41_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
