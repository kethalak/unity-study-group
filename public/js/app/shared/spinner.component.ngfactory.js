...
export function viewFactory_SpinnerComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_SpinnerComponent === null)) {
        (renderType_SpinnerComponent = viewUtils.createRenderComponentType('C:/Users/ketha/Desktop/projects/web/unitystudygroup/assets/app/shared/spinner.component.ts class SpinnerComponent - inline template', 0, import8.ViewEncapsulation.None, styles_SpinnerComponent, {}));
    }
